        ...
        Object.values(cartItems).map(item => {
            productContainer.innerHTML += `
                <div class="product">
                    ...
                    <img src="latest drop/ ,images/${item.tag}.jpg" onerror="this.src='images/${item.tag}.png';height="175px" width="236px"">
                    <span>${item.tag}</span>
                </div>
                <div class="price">Ksh${item.price}.00</div>
                <div class="quantity">
                    <i class="fas fa-chevron-lefdecrease" onclick="decreaseItem('${item.tag}')"></i>
